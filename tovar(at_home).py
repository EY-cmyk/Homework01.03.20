...
a = int(input('Введите предпочитаемое  количество Notebook:'))
b = int(input('Введите предпочитаемое  количество SmartPhone:'))
c = int(input('Введите предпочитаемое  количество Apple:'))
